...
# non hw accelerated graphics support
PRODUCT_PACKAGES += \
    libGLES_android \
...
# no-hw accelerated graphics properties to be set in system/build.prop by default
PRODUCT_PROPERTY_OVERRIDES += \
...
$(call inherit-product-if-exists, vendor/nvidia/jetson/jetson-vendor.mk)
